...
input_folders = ['hp', 'ss']	 														#Should be a list of folders where each folder contains images of a separate class
input_classes = ['hp', 'ss']															#Classes' indexes should correspond with the folder they're with
model_paths = ['../models/seed0/realno_resnet18_e19_va0.873.pt', '../models/seed0/real_resnet18_e19_va0.820.pt', '../models/seed0/no_resnet18_e19_va0.870.pt']															#Direct paths to models 
model_labels = ['CycleGAN + Real Images', 'Real Images', 'CycleGAN']																								#What to call each model
colors = ['violet', 'darkorange', 'turquoise']
binary = True
do_roc = True
...
if do_roc == True:
	...
	plt.savefig('AUROC.eps', dpi=1500, format = 'eps', bbox_inches='tight')
