...
def plot_umap(confidences_easy, confidences_hard, confidences_gen, confidences_ss):
	y_pred = []
	test_y = []		# 0 - HP; 1 - SSA
	...
	Y = umap.UMAP(n_neighbors=50, min_dist=0.1, metric='correlation').fit_transform(y_pred)
	...
	plt.savefig('UMAP.png', dpi=400, format = 'png')
...
plot_umap(confidences_easy, confidences_hard, confidences_gen, confidences_ss)
