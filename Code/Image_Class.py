...
class Image_Class:
	...
	def combine(self, other_image):
		...
		assert self.width == other_image.get_image().shape[0]
		assert self.height == other_image.get_image().shape[1]
